...
public:
    ...
    */
    ...
    /**
    * \throw std::bad_alloc if \a count > \c max_size().
    */
    ...
    */
    ...
    /**
    * \throw std::bad_alloc if \a il does not fit in \c max_size().
    */
    ...
    * \throw std::bad_alloc if \a new_cap > \c max_size().
    */
